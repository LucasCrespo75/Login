...
nome VARCHAR(100),
ID_modelo VARCHAR(100) PRIMARY KEY,
ano DATE
);
...
ano_peca DATE,
marca_veiculo VARCHAR(100) PRIMARY KEy
);

ALTER TABLE pecas
ADD FOREIGN KEY (marca_veiculo) 
REFERENCES veiculo(ID_modelo);
     

CREATE SEQUENCE S_PECAS 
